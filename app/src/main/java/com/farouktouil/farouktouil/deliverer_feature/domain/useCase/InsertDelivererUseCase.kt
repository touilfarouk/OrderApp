...
class InsertDelivererUseCase @Inject constructor(private val delivererRepository: DelivererRepository) {
suspend operator fun invoke(deliverer: Deliverer) = delivererRepository.insert(deliverer)
}